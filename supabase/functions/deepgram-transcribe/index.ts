...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Deepgram's Nova-3 multilingual mode does not cover every language we
    // need for this app. For Auto, compare English and Urdu recognition on the
    // same audio and select the higher-confidence result. Explicit language
    // requests make a single call.
