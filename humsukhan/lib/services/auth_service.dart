...
class AuthService {
  ...
  Future<AuthResult> signUp({required String email, required String password, String? name}) async {
    ...
    try {
      ...
      return AuthResult.failure('Account created, but profile synchronization failed. Please try signing in again.');
    }
  }
  ...
  Future<AuthResult> signIn({required String email, required String password}) async {
    ...
    } on AuthException catch (e) { return AuthResult.failure(e.message); } catch (_) { return AuthResult.failure('Sign in failed. Please try again.'); }
  }
