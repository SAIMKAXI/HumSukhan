...
class CloudTtsService {
  ...
  Future<CloudTtsResult> synthesize({
    ...
    try {
      // This must match the deployed Edge Function. Provider selection and
      // credentials stay server-side; the device must not probe Deepgram.
