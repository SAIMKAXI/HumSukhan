...
/// authoritative capability signal. The result is cached per language and
/// can be invalidated after voice data is installed or engine configuration
/// changes.
class TtsCapabilityService {
  ...
  Future<bool> _trySpeakLocale(FlutterTts native, String locale) async {
    // Deliberately do not gate the probe on isLanguageAvailable(). Some
    // engines report false even when the locale can still synthesize audio.
    try {
