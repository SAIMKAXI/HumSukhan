...
class _ProfessionalScreenState extends State<ProfessionalScreen> {
          ...
          return Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              onPressed: () => _showCreateSessionSheet(
                context,
                s,
                presetType: _typeForTab(controller.index),
              ),
        ...
        if (sessions.isEmpty)
          Padding(
            ...
            child: EmptyState(
              ...
              onButtonPressed: () => _showCreateSessionSheet(
                context,
                strings,
                presetType: type,
              ),
  ...
  void _showFolderSessions(
    BuildContext context,
    String name,
    List<ProfessionalSession> sessions,
  ) {
            ...
            child: Column(
              ...
              children: [
                Text(
                  presetType == null
                      ? s.newSession
                      : 'New ${_typeLabel(presetType)}',
                  style: Theme.of(ctx).textTheme.headlineSmall,
                ),
                const SizedBox(height: 8),
                Text(
                  'Set up the session once, then use the microphone with a tap to start and stop listening.',
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(
                    ...
                    helperText: 'This controls recognition. Your app language stays independent.',
                  ),
                  items: const [
                    DropdownMenuItem(
                      value: 'English',
                ...
                DropdownButtonFormField<int>(
                  ...
                  items: [
                    DropdownMenuItem(
                      value: 1,
                      child: Text(s.retention1Day),
                    ),
                    DropdownMenuItem(
                      value: 7,
                      child: Text(s.retention7Days),
                    ),
                    DropdownMenuItem(
                      value: 15,
                      child: Text(s.retention15Days),
                    ),
                  ],
                  onChanged: (value) => setState(
                  ...
                  onPressed: () async {
                    ...
                    if (title.isEmpty) {
                      ScaffoldMessenger.of(ctx).showSnackBar(
                        const SnackBar(
                          content: Text('Add a session title to continue.'),
                        ),
                      );
                      return;
                    }
