...
void main() {
  test('conversational replay resumes listening after speaking', () {
    ...
    expect(speakCall, greaterThanOrEqualTo(0));
    expect(resumeCall, greaterThan(speakCall));
    expect(body, contains('conversation.beginSpeakerTurn(language: \'Auto\')'));
    expect(body, contains('_state = ConversationEngineState.listening;'));
  });
}
